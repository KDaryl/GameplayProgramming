...
void Game::initialize()
{
	...
	triangles[3] = 3;	triangles[4] = 2;	triangles[5] = 0;

	//Right Face
	triangles[6] = 3;   triangles[7] = 5;   triangles[8] = 2;
	triangles[9] = 4;	triangles[10] = 5;	triangles[11] = 3;

	//Left Face
	triangles[12] = 0;   triangles[13] = 6;   triangles[14] = 1;
	triangles[15] = 7;	triangles[16] = 6;	triangles[17] = 0;

	//Top Face
	triangles[18] = 5;   triangles[19] = 6;   triangles[20] = 1;
	triangles[21] = 2;	triangles[22] = 5;	triangles[23] = 1;

	//Bottom Face
	triangles[24] = 0;   triangles[25] = 4;   triangles[26] = 7;
	triangles[27] = 3;	triangles[28] = 4;	triangles[29] = 0;

	//Back Face
	triangles[30] = 4;   triangles[31] = 5;   triangles[32] = 7;
	triangles[33] = 7;	triangles[34] = 5;	triangles[35] = 6;
...
void Game::readVertexShader()
{
	if (setVsSrc == false)
	{
		std::ifstream file("vertex shader.txt");
...
void Game::readFragShader()
{
	if (setFrSrc == false)
	{
		numOfChars = 0;
		std::ifstream file("fragment shader.txt");
		while (!file.eof())
		{
			file.get();
			numOfChars++;
